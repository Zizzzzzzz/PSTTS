...
# from mmengine import MMDataParallel
...
def main():
    ...
    cfg.model.backbone.pretrained = None #"/root/data1/code/Event/Action/DailyDVS-200-main/models/mmaction2_lastest/work_dir/uniformerv2-dailydvs200-3g8b/best_acc_top1_epoch_46.pth"
