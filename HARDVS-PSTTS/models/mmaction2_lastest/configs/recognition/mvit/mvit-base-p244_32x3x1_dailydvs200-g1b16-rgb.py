...
data_root = '/root/data1/dataset/DailyDvs-200-frames'
data_root_val = '/root/data1/dataset/DailyDvs-200-frames'
ann_file_train ='/root/data1/code/Event/Action/DailyDVS-200-main/full_labels/train_label.txt'
ann_file_val = '/root/data1/code/Event/Action/DailyDVS-200-main/full_labels/test_label.txt'
ann_file_test ='/root/data1/code/Event/Action/DailyDVS-200-main/full_labels/test_label.txt'
...
auto_scale_lr = dict(enable=False, base_batch_size=16 // repeat_sample)
